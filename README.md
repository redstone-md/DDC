...
- **Iron's addons** — the bridge above, shipped as data packs on each release: [Monsters & Spellbooks](https://www.curseforge.com/minecraft/mc-mods/monsters-spellbooks-iss), [Hazen 'N Stuff](https://www.curseforge.com/minecraft/mc-mods/hazen-n-stuff), and [Magic From The East](https://www.curseforge.com/minecraft/mc-mods/magic-from-the-east) bring their caster-monsters in as GM encounters *and* their spells as castable DDC spells; [Apprentice's Codex](https://www.curseforge.com/minecraft/mc-mods/apprentices-codex) and [Cataclysm: Spellbooks](https://www.curseforge.com/minecraft/mc-mods/cataclysm-spellbooks) bring their spells. All need Iron's too.
